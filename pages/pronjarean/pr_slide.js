    ...
    <>
      <Container fluid className="py-5 m1">
        <Container sm className="text-center text-light">
          <h1 className="fw-bold ">ศูนย์เรียนรู้ชุมชนอำเภอพรเจริญ</h1>
          <p className="my-4 w-75 m-auto">
            ศูนย์เรียนรู้เกษตรอินทรีย์ PGS ตั้งอยู่ที่ตำบลพรเจริญ อำเภอพรเจริญ
            จังหวัดบึงกาฬ เป็นศูนย์เรียนรู้ที่มุ่งเน้นการทำเกษตรอินทรีย์
            ซึ่งเป็นวิธีการเกษตรที่ไม่ใช้สารเคมี
            และมุ่งเน้นความยั่งยืนในการจัดการทรัพยากรธรรมชาติ
            เป็นวิถีชีวิตที่ยังคงได้รับความนิยมในปัจจุบัน
          </p>
          ...
          <center>
            <Link
              ...
              className="btn btn-outline-light btn-lg rounded-5 fw-bold "
            >
              ดูเพิ่มเติม
            </Link>
          </center>
