          ...
          >
            <div>
              <Link
                ...
                className="fw-bold bg-light text-center p-2 px-3 rounded-5 btn btn-light mb-3 fs-4"
              >
                ศูนย์เรียนรู้เกษตรอินทรีย์ PGS <FontAwesomeIcon icon={faEye} />
              </Link>
              <p className="pe-4 text-light text-shadow">
                ศูนย์เรียนรู้เกษตรอินทรีย์ PGS ตั้งอยู่ที่ตำบลพรเจริญ
