      ...
      <Container className="py-4">
        <Row>
          ...
          <Col sm={3}>
            ...
            <Link
              href="https://www.facebook.com/profile.php?id=100009416371123"
            ...
            <br />
            <Link
              href="https://www.facebook.com/profile.php?id=100035653402081"
              className="text-light text-decoration-none"
            >
              Settawat Wongsuna
            </Link>
          ...
          <Col sm={3}>
            ...
            <a>62540427102@udru.ac.th</a>
            <br />
            <FontAwesomeIcon icon={faEarthAmericas} />
            <a
              className="text-decoration-none text-light"
              href="https://www.udru.ac.th/"
            >
              {" "}
              udru.ac.th
            </a>
